        ...
        <nav className='md:hidden font-sans'>
            ...
            {isMenuOpen && (
                <div className='w-full bg-[#FFFFFF] flex flex-col items-center space-y-4 text-[#737373] text-[30px] font-normal pt-4'>
                    ...
                    <ul className="flex flex-col items-center text-[#601363] text-[30px] space-y-4 pt-4">
                    ...
                    {cartQuantity > 0 && (
                        <span className=" text-[#601363] text-[20px]  py-1">
                            {cartQuantity}
                        </span>
                    )}</li>
                        <li className='flex items-center gap-[2px]'>
                    <Link href="/wishlist" className="text-[#601363] hover:text-purple-700">
                        <FaRegHeart className='text-[#601363] hover:text-purple-700' />
                    </Link>
                    {wishlistQuantity > 0 && (
