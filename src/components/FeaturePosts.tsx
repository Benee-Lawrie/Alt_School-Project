          ...
          <div className="shadow flex-1">
            <div className="relative">
              <Image
                ...
                className="w-full"
              />
              <h4 className="absolute top-0 bg-[#601363] px-[10px] text-[#FFFFFF] text-[14px] font-bold leading-6 rounded m-5">
                NEW
              </h4>
            </div>
            <div className="p-[25px]">
              <div className="flex items-center mt-[25px] gap-[15px]">
                <p className="text-[#f02ef6] text-[12px] leading-4">Google</p>
