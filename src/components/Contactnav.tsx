...
const Contactnav = () => {
    return (
        <nav className='custom-md:block bg-[#601363] text-white hidden font-sans'>
            <div className='max-w-full lg:max-w-[1439px] flex text-[8px] items-center justify-between h-auto m-auto px-4 sm:px-8 lg:px-[32px] py-2 sm:py-4 lg:py-[24px] text-xs lg:text-sm'>
                <span className='flex justify-center items-center gap-4 sm:gap-6 lg:gap-[29.5px]'>
                    <span className='flex items-center gap-2 sm:gap-4 lg:gap-[5px] hover:text-[#f02ef6] transition-colors duration-300'>
                ...
                <p className='hover:text-[#f02ef6]'> Follow Us and get a chance to win 80% off </p>
                <div className='flex justify-center items-center gap-3 sm:gap-5 lg:gap-[15.5px]'>
                    <span className='text-sm transition-colors duration-300'>
                        <p className='hover:text-[#f02ef6]'> Follow Us : </p>
                    </span>
                    <span className='hover:text-[#f02ef6] transition-colors duration-300'>
