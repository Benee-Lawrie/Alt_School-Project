...
const Login = () => {
  ...
  return (
    <div className="max-w-md m-auto h-screen md:h-[88.5vh] px-[20px] flex items-center">
      ...
      <h2 className="text-2xl font-bold mb-6 text-[#601363]">Login</h2>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button type="submit"className="w-full bg-[#601363] text-white py-2 mt-4 rounded border-b-2 border-custom-purple">Login</button>
